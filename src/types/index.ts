export enum TownOfPolusGameOptionNames {
  ...
  PhantomProbability = "<size=150%><sprite index=9> </size><color=#8cffff>Phantom</color>",
  ...
  SerialKillerProbability = "<size=150%><sprite index=10> </size><color=#ff547c>Serial Killer</color>",
  ...
  SheriffProbability = "<size=150%><sprite index=12> </size><color=#c49645>Sheriff</color>",
  SheriffCooldown = "<color=#c49645>Sheriff</color> Cooldown",

  SnitchProbability = "<size=150%><sprite index=11> </size><color=#00ffdd>Snitch</color>",
  SnitchRemainingTasks = "<color=#00ffdd>Snitch</color> Remaining Tasks",

  LocksmithProbability = "<size=150%><sprite index=14> </size><color=#3d85c6>Locksmith</color>",
